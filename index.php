...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> © 2021 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://1sourcecodr.blogspot.com/" target="_blank">Ihsan hanif febriliyan</a></div></div>
        </footer>
